...
void freeAST(ASTNode* node) {
    ...
    switch (node->type) {
        case NodeType_Program:
            ...
            break;
        case NodeType_VarDeclList: // recursive free
        ...
        case NodeType_SimpleExpr: // no dynamic memory allocation, free not needed
        ...
        case NodeType_Expr:
            ...
            // no dynamic memory allocation for operator, free not needed
